...
export default function CarHireAndSecurityOnlyServices() {
            ...
            <Box className={classes.uppercard} disableRipple={true}>
              ...
              >
                <Grid
                  ...
                  alignItems="center"
                >
                  <Typography variant="h5" style={{marginLeft:100, marginBottom:20}}>Need Car Hire & Security Services Only? We’ve Got You</Typography>
                  ...
                  >
                    <Typography>
                    Book chauffeur-driven cars, SUVs, and VIP buses with optional armed or unarmed security escorts — no protocol package needed.
                    </Typography>
                  </Grid>
