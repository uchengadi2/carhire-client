...
import heroImage from "./../../../assets/images/site/accommodation2.webp";
...
export default function AccommodationAssessmentSection() {
            ...
            <Box className={classes.uppercard} disableRipple={true}>
              ...
              >
                ...
                {/* <Typography variant="h3" style={{marginLeft:'0%',marginBottom:30}}>Chauffeur-Driven Exotic Car Rentals in Lagos</Typography> */}
                  ...
                  >
                    <Typography variant="h3" style={{marginLeft:'0%',marginBottom:30}}>Verified Accommodation Services for Executives & Businesses Across Nigeria</Typography>
