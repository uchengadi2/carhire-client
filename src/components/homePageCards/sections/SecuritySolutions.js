...
import heroImage from "./../../../assets/images/site/securiyu3.webp";
              ...
              <Box className={classes.uppercard} disableRipple={true}>
                ...
                >
                  ...
                  {/* <Typography variant="h4" style={{marginLeft:'50%',marginBottom:30, fontSize:30, fontWeight:700, color:"black"}}>Airport Protocol Services</Typography> */}
                    ...
                    >
                      <Typography variant="h3" style={{marginLeft:'0%',marginBottom:30}}>Seamless Airport Protocol Services in Nigeria.</Typography>
                    ...
                    <Grid
                          ...
                          >
                            ...
                            {/* <Typography style={{marginTop:0, padding: 70}}>
                              ...
                              >
                                <Typography variant="h5" style={{marginLeft:'5%',marginBottom:10}}>For Brands</Typography>
                                <Typography style={{marginTop:10, fontSize:10}}>
                                      <ReactMarkdown>{brandProcess}</ReactMarkdown>
                                </Typography>
                                ...
                                <Typography variant="h5" style={{marginLeft:'5%',marginBottom:10}}>For Army Members (Participants):</Typography>
                                <Typography style={{marginTop:10, fontSize:10}}>
                                      <ReactMarkdown>{armyProcess}</ReactMarkdown>
                                </Typography>
                              </Grid>
